  ...
  return (
    <section className="flex flex-col w-full px-4 sm:px-6 lg:px-8 xl:px-12 py-16 sm:py-20 lg:py-24 relative overflow-hidden">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div
          className="absolute top-20 left-1/4 w-40 h-40 bg-gradient-to-br from-indigo-500/5 to-purple-500/5 rounded-full blur-2xl"
          animate={{ scale: [1, 1.3, 1], x: [0, 30, 0] }}
          transition={{ duration: 12, repeat: Infinity }}
        />
        <motion.div
          className="absolute bottom-32 right-1/3 w-48 h-48 bg-gradient-to-br from-blue-500/5 to-cyan-500/5 rounded-full blur-2xl"
          ...
          >
            <div className="flex-1 text-center lg:text-left">
              <div className="flex items-center justify-center lg:justify-start gap-4 mb-4">
                <span className="text-6xl sm:text-7xl font-extrabold bg-gradient-to-r from-blue-400 to-purple-400 text-transparent bg-clip-text opacity-20">
                  {step.step}
                </span>
                <div>
            ...
            <div className="flex-1 flex justify-center">
              <div className="relative">
                <motion.div
                  className="w-32 h-32 sm:w-40 sm:h-40 rounded-full bg-gradient-to-br from-blue-500/20 to-purple-500/20 border-2 border-blue-400/30 flex items-center justify-center relative"
                ...
                />
                <motion.div
                  className="absolute top-0 left-1/2 w-1.5 h-1.5 bg-purple-400 rounded-full transform -translate-x-1/2"
                  animate={{ rotate: -360 }}
            ...
            {i < processSteps.length - 1 && (
              <div className="hidden lg:block absolute left-1/2 bottom-0 transform -translate-x-1/2 translate-y-8">
                <motion.div
                  className="w-px h-16 bg-gradient-to-b from-blue-400/50 to-transparent"
                  initial={{ scaleY: 0 }}
