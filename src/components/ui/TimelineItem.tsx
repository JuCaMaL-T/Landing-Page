...
import { Calendar, TrendingUp, ImageIcon } from "lucide-react"
  ...
  return (
    ...
    >
      <div className={`flex-1 ${isEven ? "lg:text-right" : "lg:text-left"} text-center lg:text-left`}>
        ...
        >
          <div className="bg-gradient-to-br from-black/70 to-black/50 backdrop-blur-lg rounded-2xl overflow-hidden relative">
      ...
      <div className="hidden lg:flex items-center justify-center relative">
        <motion.div
          className="w-16 h-16 rounded-full bg-gradient-to-r from-blue-500 to-blue-900 flex items-center justify-center relative z-10"
